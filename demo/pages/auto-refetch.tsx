...
const AutoRefetch = () => {
  ...
  const [mutateClear] = useMutation((event: React.MouseEvent) => fetch(`/api/data?clear=1`), {
    onSuccess: () => queryCache.invalidateQueries("todos"),
  });
  ...
  return (
    <div>
      ...
      <p>
        This example is best experienced on your own machine, where you can open multiple tabs to
        the same localhost server and see your changes propagate between the two.
      </p>
      <label>
